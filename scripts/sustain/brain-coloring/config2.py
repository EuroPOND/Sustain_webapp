...
INPUT_FILE = 'input/Tourville_template_D.csv' # input template should match ATLAS below
#INPUT_FILE = 'input/Tourville_template.csv'
...
IMG_TYPE = 'cortical-inner-right-hemisphere'
...
#COLORS_RGB = [(1,1,1), (0,0,1), (0,1,0), (1,1,0)] #yellow-green-blue
COLORS_RGB = [(1,1,1), (249/255,231/255,33/255), (33/255,144/255,141/255), (69/255,2/255,86/255)] #viridis reversed simplified
